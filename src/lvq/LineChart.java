...
public class LineChart {
    ...
    public static void showChart(String title, double[][] data, String lineName, String xName, String yName) {
        ...
        ImageIcon icon = new ImageIcon("G:\\ProgramTugasAkhir\\DeteksiBuah\\src\\aset\\fruit.png");
    ...
    public static void showChart2Line(String title, double[][] data, String lineName,
        ...
        JFrame frame = new JFrame(title);
        ImageIcon icon = new ImageIcon("\\aset\\neural.png");
        frame.setIconImage(icon.getImage());
        frame.setSize(600, 400);
        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        frame.setVisible(true);
        ...
        JFreeChart chart = ChartFactory.createXYLineChart(title,xName, yName, ds, PlotOrientation.VERTICAL, true, true,false);
